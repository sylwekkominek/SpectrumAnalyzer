...
VerticalLinePositions::VerticalLinePositions(const ThemeConfig themeConfig) : value(getVerticalLinePositions(themeConfig))
{
}
...
Frequencies VerticalLinePositions::getVerticalLinePositions(const ThemeConfig themeConfig)
{
