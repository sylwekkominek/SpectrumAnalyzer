...
public:
    ...
    void checkFrequencyIndex(const std::vector<uint32_t> &expectedIndexes, const IndexSelector &indexSelector)
    {
...
TEST_F(IndexSelectorTests, testIndexesWithFFTSize1024)
{
    ...
    const std::vector<uint32_t> expectedIndexes{1,1,1,23,24,116};
...
TEST_F(IndexSelectorTests, testIndexesWithFFTSize2048)
{
    ...
    const std::vector<uint32_t> expectedIndexes{1,1,1,46,47,232};
...
{
    const uint32_t fftSize{4096};
    const Frequencies frequencies{10,11,12,995,996,5000};
    const std::vector<uint32_t> expectedIndexes{1,1,1,92,93,464};
...
{
    const uint32_t fftSize{4096};
    const uint32_t samplingRate{48000};

    const Frequencies frequencies{10,11,12,1001,1002,5000};
    const std::vector<uint32_t> expectedIndexes{1,1,1,85,86,427};
